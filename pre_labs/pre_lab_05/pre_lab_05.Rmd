...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer The headers are weird! But that's because we didn't give it headers in the first place.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer: The header names make more sense cause they are in order and Maryland is in the data, but the column names are still not helpful.**
...
**Task** Run the codeblock below. What else do we need to do? **Answer All the periods are super annoying after the jurisdiction names**
