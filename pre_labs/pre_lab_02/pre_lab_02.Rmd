...
**Answer: It changed the order that the date shows in, from Month-Date-Year to Year-Month-Datege**
...
**Answer The mutate function here is assuming that the new group columns of addresses that just list states should just be NA, unless it sees any of the state names in the address is one of the ones listed in the str_detect function. This will give us a count of how many times certain states appear**
...
**Answer This somewhat makes sense. I am a little unsure why the numbers I got back when I ran this code are so large, and wonder if I am misunderstanding the context of the numbers that appear. I think I was expecting more a count, but there is no count function in this. I am wondering if I did something wrong, but also a bit uncertain if I understand this data set shown in the mutated table.**
...
1.  We could ask who has received the most frequent expenses from Maryland?

2.  We could ask what expense category Maryland funds most often?

3.  We could look at the purpose tab to see the most common purpose of Maryland expenses?
