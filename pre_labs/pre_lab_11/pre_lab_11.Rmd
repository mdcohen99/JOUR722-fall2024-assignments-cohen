...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer The problem with the sentiments is that it is truly binary. It is either one or the other. But as human, we know that context is important and one word can mean something different in certain situations. For example, the Bing list includes "limited" as a negative word. At the surface, sure, it can be negative. But what is being limited? Are we limiting crime? Because that would be a good thing. Are we limiting poverty? That's good too. So the element of being human still matters and a computer can't quite determine all of that.**
