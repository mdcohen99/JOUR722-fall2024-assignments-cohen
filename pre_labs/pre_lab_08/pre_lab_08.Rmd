...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer a big gray square!**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer A basic bar chart showing that PG County and Montgomery County had the biggest changes in unaffiliated voters**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: it now lists the counties from the smallest to the biggest difference in unaffiliated voters**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer it flipped the graph 90 degrees so that the x axis is easier to read**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer it got rid of the gray backdrop to make it white**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: After the chart originally had a gray background and both vertical and horizontal lines, we now have a light blue background and only horizontal lines. The theme is made to look like a chart from the Economist. But it still doesn't look quite right.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer now it has tables including a title**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer it shows the total political contributions made per day in maryland**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer a bad looking line chart!**
